<?php
class AnimalDAO{
    // retourne tous les animaux (pour pouvoir les afficher tous etc ...)
    ...
    public static function getImagesAnimal($idAnimal){
        ...
        // Non, pas besoin de 2 jointures car l'idAnima on peut le récuperer après la 1ère jointures
        // Par contre si on voulait le nom de l'animal (une info qui n'existe pas dnas la table
        // intermédiaire) il aurait fallu faire la 2ème jointure !!!!! 
        $req = '
        SELECT libelle, url 
        FROM image i

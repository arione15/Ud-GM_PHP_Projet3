...
5. le but n'étant pas d'afficher les animaux récupérés depuis la BD grâce à la fonction getAnimauxBD() mais plutôt d'instancier chaque animal (on récupère la liste des animaux sous forme de tableau assoc. Mais on veut obtenir

...
foreach($animaux as $animal){
    ...
    new Animal($animal['idAnimal'],$animal['nom'],(int)$animal['age'],(int)$animal['sexe'],$animal['idType'], ""); // puis régler le type (avoir le libellé par juste le numéro) et les images en créant de nouvelles requêtes (nouvelles fonctions : getTypeAnimal() et )

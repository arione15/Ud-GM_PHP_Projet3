...
2. **<u>Pour n'avoir qu'une seule instance d'une classe :</u>**
    ...
    - Créer une fonction pour pouvoir l'utiliser partout (donc static) pour, soit instancier la classe de PDO si `$monPDO` n'existe pas, soit récupérer l'instance (unique) `$monPDO` si elle existe :
        ...
        public static function getPDO(){
            ...
            return 
        ```
3. Dans la classe `Animal.class-h` mettre un tableau static pour y stocker tous les animaux crées.

4. Créer la classe AnimalDAO-h qui ne contient que des fonctions statiques pour les differentes requêtes sur nos différentes tables de la BD.

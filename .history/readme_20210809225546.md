...
5. le but n'étant pas d'afficher les animaux récupérés depuis la BD grâce à la fonction getAnimauxBD() mais plutot // Instancier chaque animal ( : on récupère la liste

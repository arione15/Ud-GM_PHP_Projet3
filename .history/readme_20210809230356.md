...
```php
$animaux = AnimalDAO::getAnimauxBD(); // on récupère les animaux de la BD
foreach($animaux as $animal){
    // pour avoir des objets , on instancie en donnant au constructeur les paramètres récupérés epuis la BD 

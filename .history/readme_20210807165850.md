...
5. Créer la classe AnimalDAO-h qui ne contient que des fonctions statiques où on écrit des fonctions pour les differentes requêtes sur nos différentes tables de la BD.
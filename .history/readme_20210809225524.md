...
5. le but n'étant pas d'afficher les animaux récupérées depuis la BD grace à la fonction getAnimauxBD() mais // Instancier chaque animal ( : on récupère la liste

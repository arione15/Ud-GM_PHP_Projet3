...
foreach($animaux as $animal){
    ...
    new Animal($animal['idAnimal'],$animal['nom'],(int)$animal['age'],(int)$animal['sexe'],$animal['idType'], ""); // puis régler (avoir le libellé par juste le numéro) le type et les images

...
<table class="table">
    ...
    <tbody>
        <?php foreach (Animal::$mesAnimaux as $animal) { ?> // Pour afficher, on utilise maintenant les objets du tableau static static $mesAnimaux qu'on créeé pour y stocker les instances de la classe Animal
            <tr>

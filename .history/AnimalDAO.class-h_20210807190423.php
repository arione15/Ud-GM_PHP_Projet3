...
class AnimalDAO{
    ...
    public static function getImagesAnimal($idAnimal){
        ...
        // Pas besoin de 2 jointures car l'idAnima on peut le récuperer après la 1ère jointures// Par contre si on voulait le nom de l'animal (une info qui n'existe pas dnas la table intermédiaire) il fallai!!! 
        $req = '
        SELECT libelle, url 
        FROM image i
